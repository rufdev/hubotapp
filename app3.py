...
# # Add a new output layer with the desired number of units and a unique name
# num_classes = 2
# model.add(tf.keras.layers.Dense(num_classes, activation='softmax', name='new_output'))
...
filenames=os.listdir("./onlinedataset")
...
train_generator = train_datagen.flow_from_dataframe(train_df, "./onlinedataset" ,x_col='filename' ,y_col='category', target_size=Image_Size, class_mode='categorical', batch_size=batch_size)

validation_datagen = tf.keras.preprocessing.image.ImageDataGenerator(rescale=1./255)
validation_generator = validation_datagen.flow_from_dataframe( validate_df, "./onlinedataset", x_col='filename', y_col='category', target_size=Image_Size, class_mode='categorical', batch_size=batch_size )
